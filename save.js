...
const SECRETS = {
    secret_flawless_boss: {
        ...
        cutscene: 'Страж не задел тебя ни разу. Пока он рассыпается, помехи на секунду уходят, и в чистом канале проступает чужая строка: если ты это читаешь, протокол ещё можно откатить. Отправили её за два дня до Потопа.',
    ...
    secret_dasher: {
        ...
        cutscene: 'После двухсотого рывка сеть узнала твой почерк и подняла из архива файл УЧАСТНИК #0. Там имя, которое ты носил до Потопа, дата найма и пустая графа причины увольнения. Файл закрылся сам.',
        cosmetic: 'blue_trail'
    },
    secret_scrapper: {
