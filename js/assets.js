...
// Лист 1344x96 = 14 кадров по 96x96, рисует его tools/make_boom.py.
// Если подложить свой лист другого размера — править нарезку здесь.
let FX_BOSS_CUT = { fw: 96, fh: 96, cols: 14, frames: 14, start: 0 };
