...
function drawBigMap() {
    ...
    ctx.font = "12px 'Press Start 2P', monospace"; ctx.fillStyle = UI.txt; ctx.textAlign = 'left';
    ctx.fillText('ТАКТИЧЕСКАЯ КАРТА', ox, oy - 14);
    ctx.textAlign = 'right'; ctx.fillStyle = UI.txtDim; ctx.font = "10px 'Press Start 2P', monospace";
    ...
    ctx.stroke();
    ctx.textAlign = 'center'; ctx.fillStyle = UI.txtDim; ctx.font = "9px 'Press Start 2P', monospace";
